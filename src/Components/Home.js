    ...
    <div className='container'>
        ...
        <div className='row'>
          <div className='col-md-6'>
            <div className='card'>
              <img src={E} className='card-img-top' alt='Event Planning' />
            ...
            <div className='card mb-2'>
              <img src={bg2} className='card-img-top' alt='On-site Support' />
              <div className='card-body'>
          ...
          <div className='col-md-6'>
            ...
            <div className='card'>
              <img src={A} className='card-img-top' alt='Guest List Management' />
              <div className='card-body'>
